...
lbm.define('lbm.ui', function() {
   ...
   * @type {boolean}
   */
  lbm.defineProperty(ListItem, 'selected', lbm.PropertyKind.BOOL_ATTR,
                    function() {
   ...
   * @type {boolean}
   */
  lbm.defineProperty(ListItem, 'lead', lbm.PropertyKind.BOOL_ATTR);

  /**
   * This item's index in the containing list.
   * @type {number}
   */
  lbm.defineProperty(ListItem, 'listIndex');
