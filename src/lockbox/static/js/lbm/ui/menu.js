...
lbm.define('lbm.ui', function() {
  ...
  const MenuItem = lbm.ui.MenuItem;
  ...
  Menu.prototype = {
    ...
    decorate: function() {
      ...
      for (var i = 0, child; child = children[i]; i++) {
        lbm.ui.decorate(child, MenuItem);
      }
    },
     ...
     * @param {Element} el
     * @return {lbm.ui.MenuItem} The found menu item or null.
     * @private
     */
    ...
    handleKeyDown: function(e) {
      ...
      switch (e.keyIdentifier) {
        ...
        case 'U+0020': // Space
          if (item) {
            if (lbm.dispatchSimpleEvent(item, 'activate', true, true)) {
              if (item.command)
   ...
   * @type {number}
   */
  lbm.defineProperty(Menu, 'selectedIndex', lbm.PropertyKind.JS,
