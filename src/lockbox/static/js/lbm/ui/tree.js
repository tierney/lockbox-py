...
lbm.define('lbm.ui', function() {
  // require lbm.ui.define
  // require lbm.ui.limitInputWidth
   ...
   * @return {lbm.ui.TreeItem} The found tree item or null if not found.
   */
  ...
  Tree.prototype = {
     ...
     * @param {!lbm.ui.TreeItem} treeItem The item to add.
     */
     ...
     * @param {!lbm.ui.TreeItem} treeItem The tree item to remove.
     */
    ...
    handleKeyDown: function(e) {
      ...
      switch (e.keyIdentifier) {
        ...
        case 'Right':
          ...
          if (!lbm.isMac && e.altKey || lbm.isMac && e.metaKey)
            break;
   ...
   * property.
   */
  lbm.defineProperty(Tree, 'iconVisibility', lbm.PropertyKind.ATTR);
  ...
  var treeItemProto = (function() {
    var treeItem = lbm.doc.createElement('div');
   ...
   * @extends {HTMLElement}
   */
  var TreeItem = lbm.ui.define(function() {
  ...
  TreeItem.prototype = {
     ...
     * @param {!lbm.ui.TreeItem} child The child to add.
     */
    add: function(child) {
    ...
    /**
     * Removes a child.
     * @param {!lbm.ui.TreeItem} child The tree item child to remove.
     */
     ...
     * @type {!lbm.ui.Tree|lbm.ui.TreeItem}
     */
    get parentItem() {
    ...
    set expanded(b) {
      ...
      if (b) {
        if (this.mayHaveChildren_) {
          ...
          lbm.dispatchSimpleEvent(this, 'expand', true);
        ...
        lbm.dispatchSimpleEvent(this, 'collapse', true);
      }
    },
    ...
    set editing(editing) {
      ...
      if (editing) {
        ...
        function onFocus() {
          ...
          lbm.ui.limitInputWidth(input, rowElement, 100);
        }
        ...
        if (/^\s*$/.test(value)) {
          ...
          if (value != this.oldLabel_) {
            lbm.dispatchSimpleEvent(this, 'rename', true);
          }
        }
   ...
   * @param {lbm.ui.TreeItem} item The tree item.
   * @retrun {lbm.ui.TreeItem} The found item or null.
   */
   ...
   * @param {lbm.ui.TreeItem} item The item to find the last visible item for.
   * @return {lbm.ui.TreeItem} The found item or null.
   */
