...
lbm.define('lbm.ui.table', function() {
   ...
   * @param {!Array<lbm.ui.table.TableColumn>} columnIds Array of table columns.
   * @constructor
   * @extends {EventTarget}
   */
  ...
  TableColumnModel.prototype = {
    ...
    setName: function(index, name) {
      ...
      lbm.dispatchSimpleEvent('change');
    },
    ...
    setWidth: function(index, width) {
      ...
      lbm.dispatchSimpleEvent(this, 'resize');
    },

    /**
     * Returns render function for the column at the given index.
     * @param {number} index The index of the column.
     * @return {Function(*, string, lbm.ui.Table): HTMLElement} Render function.
     */
     ...
     * @param {number} index The index of the column.
     * @param {Function(*, string, lbm.ui.Table): HTMLElement} Render function.
     */
