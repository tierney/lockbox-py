...
lbm.define('lbm.ui', function() {
   ...
   * @extends {HTMLElement}
   */
  var TabBox = lbm.ui.define('tabbox');
   ...
   * @type {number}
   */
  lbm.defineProperty(TabBox, 'selectedIndex', lbm.PropertyKind.JS_PROP,
  ...
  Tabs.prototype = {
    ...
    decorate: function() {
      ...
      this.focusOutlineManager_ =
          lbm.ui.FocusOutlineManager.forDocument(this.ownerDocument);
    },
   ...
   * @extends {HTMLElement}
   */
  var Tab = lbm.ui.define('tab');
  Tab.prototype = {
    __proto__: HTMLElement.prototype,
    decorate: function() {
      var self = this;
      this.addEventListener(lbm.isMac ? 'click' : 'mousedown', function() {
        self.selected = true;
      });
    }
  };
   ...
   * @type {boolean}
   */
  lbm.defineProperty(Tab, 'selected', lbm.PropertyKind.BOOL_ATTR);
   ...
   * @extends {HTMLElement}
   */
  var TabPanels = lbm.ui.define('tabpanels');
  TabPanels.prototype = {
    __proto__: HTMLElement.prototype,
   ...
   * @extends {HTMLElement}
   */
  var TabPanel = lbm.ui.define('tabpanel');
  TabPanel.prototype = {
    __proto__: HTMLElement.prototype,
    decorate: function() {}
  };
   ...
   * @type {boolean}
   */
  lbm.defineProperty(TabPanel, 'selected', lbm.PropertyKind.BOOL_ATTR);
