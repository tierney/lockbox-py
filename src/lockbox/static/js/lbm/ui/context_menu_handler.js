...
lbm.define('lbm.ui', function() {
  ...
  ContextMenuHandler.prototype = {
     ...
     *     event).
     * @param {!lbm.ui.Menu} menu The menu to show.
     */
    ...
    hideMenu: function() {
      ...
      // to be shown again.
      this.hideTimestamp_ = lbm.isWindows ? Date.now() : 0;
    },

    /**
     * Positions the menu
     * @param {!Event} e The event object triggering the showing.
     * @param {!lbm.ui.Menu} menu The menu to position.
     * @private
     */
    positionMenu_: function(e, menu) {
      ...
      lbm.ui.positionPopupAtPoint(x, y, menu);
    },
    ...
    addContextMenuProperty: function(element) {
      ...
      element.__defineSetter__('contextMenu', function(menu) {
        ...
        lbm.dispatchPropertyChange(this, 'contextMenu', menu, oldContextMenu);
      });
