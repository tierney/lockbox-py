...
lbm.define('lbm.ui', function() {
   ...
   * @param {lbm.ui.ListSelectionModel} selectionModel The selection model to
   *     interact with.
   * @param {lbm.ui.Grid} grid The grid to interact with.
   * @constructor
   * @extends {!lbm.ui.ListSelectionController}
   */
