...
lbm.define('lbm.ui', function() {
  ...
  List.prototype = {
     ...
     * @private
     */
    itemConstructor_: lbm.ui.ListItem,
     ...
     * @type {lbm.ui.ListSelectionModel}
     */
    get selectionModel() {
     ...
     * @param {!lbm.Event} e Event with change info.
     * @private
     */
     ...
     * @param {lbm.ui.ListSelectionModel} sm The underlying selection model.
     * @return {!lbm.ui.ListSelectionController} The newly created selection
     *     controller.
     */
  ...
  lbm.defineProperty(List, 'disabled', lbm.PropertyKind.BOOL_ATTR);
   ...
   */
  lbm.defineProperty(List, 'hasElementFocus', lbm.PropertyKind.BOOL_ATTR);
