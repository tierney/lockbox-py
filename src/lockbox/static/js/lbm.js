...
const lbm = (function() {
  ...
  // lbm.Event is called CrEvent in here to prevent naming conflicts. We also
  // store the original Event in case someone does a global alias of lbm.Event.
  const DomEvent = Event;

  /**
   * Creates a new event to be used with lbm.EventTarget or DOM EventTarget
   * objects.
  ...
  function CrEvent(type, opt_bubbles, opt_preventable) {
    var e = lbm.doc.createEvent('Event');
   ...
   *     for.
   * @param {lbm.PropertyKind} kind The kind of property we are getting the
   *     setter for.
   ...
   * @param {lbm.PropertyKind=} opt_kind What kind of underlying storage to use.
  ...
  function dispatchSimpleEvent(target, type, opt_bubbles, opt_cancelable) {
    var e = new lbm.Event(type, opt_bubbles, opt_cancelable);
