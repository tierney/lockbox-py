...
lbm.define('lbm.ui', function() {
  const ListSelectionModel = lbm.ui.ListSelectionModel;
  const ListSelectionController = lbm.ui.ListSelectionController;
  const ArrayDataModel = lbm.ui.ArrayDataModel;
  const TableColumnModel = lbm.ui.table.TableColumnModel;
  const TableList = lbm.ui.table.TableList;
  const TableHeader = lbm.ui.table.TableHeader;
  ...
  Table.prototype = {
     ...
     *
     * @type {lbm.ui.table.TableColumnModel}
     */
    get columnModel() {
     ...
     *
     * @type
     * {lbm.ui.ListSelectionModel|lbm.ui.table.ListSingleSelectionModel}
     */
    get selectionModel() {
     ...
     * @return {Function(*, lbm.ui.Table): HTMLElement} Render function.
     */
     ...
     * @param {Function(*, lbm.ui.Table): HTMLElement} Render function.
     */
   ...
   */
  lbm.defineProperty(Table, 'hasElementFocus', lbm.PropertyKind.BOOL_ATTR);
