...
/**
 * @fileoverview This extends lbm.ui.List for use in the table.
 */

lbm.define('lbm.ui.table', function() {
  const List = lbm.ui.List;
  const TableRow = lbm.ui.table.TableRow;
   ...
   * @extends {lbm.ui.List}
   */
  var TableList = lbm.ui.define('list');
   ...
   * @type {lbm.ui.Table}
   */
  lbm.defineProperty(TableList, 'table');
